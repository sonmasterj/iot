...
class QtWaitingSpinner(QWidget):
    mColor = QColor(40,116,166)
    mRoundness = 70
    mMinimumTrailOpacity = 60
    mTrailFadePercentage = 10
    ...
    def paintEvent(self, event):
        ...
        for i in range(self.mNumberOfLines):
            ...
            painter.drawRoundedRect(QRect(0, -self.mLineWidth // 2, self.mLineLength, self.mLineWidth),
